...
function Home() {
  ...
  <div data-aos='zoom-in' data-aos-delay='50' className="relative z-10 bg-white bg-opacity-60 shadow-lg backdrop-blur-sm p-8 rounded-lg  text-center max-w-xl flex flex-col items-center">
  ...
  <div data-aos='zoom-in' data-aos-delay='50' className='bg-white rounded-lg shadow-lg max-w-xl text-center bg-opacity-60 backdrop-blur-sm p-5'>
